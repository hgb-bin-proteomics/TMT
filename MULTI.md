...
- Put all your `.raw` files and identification files (e.g. precursors) in the same folder.
  - For example, let's call this folder `tmt_files`.
- Precursor files should end in the suffix `_precursor.parquet` and be in parquet format.
- For example, like this:
  - `20250519_Astral1_Evo_TH070_TT_THIDmulti003_pool_DIA_mz0c5_3ng_1.raw`
...
- Put all your `.raw` files and identification files (e.g. precursors) in the same folder.
  - For example, let's call this folder `tmt_files`.
- Precursor files should end in the suffix `_precursor.csv` and be in comma-separated (`.csv`) format.
- For example, like this:
  - `20250519_Astral1_Evo_TH070_TT_THIDmulti003_pool_DIA_mz0c5_3ng_1.raw`
